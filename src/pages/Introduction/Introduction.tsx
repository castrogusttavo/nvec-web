  ...
  return (
    <div className="flex items-center justify-center">
      <div className="max-w-[1256px]">
        <div className="flex flex-col pt-20 gap-6 xl:w-full xl:px-0">
          <div className="flex py-0 px-5 flex-col justify-center items-center gap-4 md:px-[95px] lg:flex-row lg:px-0 lg:justify-between xl:w-full">
            ...
            <p className="text-[#C4C4C4] px-4 text-center text-base font-normal lg:text-start lg:text-lg xl:pl-10 xl:max-w-[600px]">
              Organize suas compras e finanças em um só lugar com nosso
              relatório intuitivo, que permite acompanhar despesas, definir
              limites de gastos e visualizar dados detalhados.
            </p>
          </div>
