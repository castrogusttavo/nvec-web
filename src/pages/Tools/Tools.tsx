...
export function Tools() {
  return (
    <div className="bg-[#FFF] flex py-20 flex-col items-center">
      <div className="max-w-[1256px] flex px-5 flex-col items-start gap-10">
        ...
        <div className="flex pb-10 flex-col item-start gap-6 self-stretch border-t-2 border-solid border-[#E1E1E6] pt-10">
          <h2 className="text-[#002F27] font-sans text-xl font-medium">
            Para sua empresa
          </h2>
          <ToolContainer
