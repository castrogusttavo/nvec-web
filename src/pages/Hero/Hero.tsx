...
export function Hero() {
  return (
    <div className="flex md:items-start md:justify-between md:flex-row flex-col pt-10 pb-20 px-5 gap-6 justify-center items-center bg-gradient-to-t from-[#E0FAF3] to-[#FFF]">
      <div className="max-w-[1256px]">
        <div className="flex flex-col justify-center md:items-start items-center gap-6 self-stretch">
          ...
          <div className="flex flex-col md:items-start items-center gap-4 ">
            <h2 className="text-[#002F27] md:text-start text-center font-medium text-3xl">
